...
#define MAX_SRC_RELAYCNT      12       //Maximum source route relay list length
...
extern void RTG_GetRtgSrcEntry( uint16 dstAddr, uint8* pRelayCnt, uint16** ppRelayList);
...
extern void RTG_SendBrokenRoute( uint16 nwkSrcAddr, uint16 nwkDstAddr, 
                         uint8 srcRouteSet, uint16 macDstAddr );
