...
/*
 * APSME_TCLinkKeySetup - Configure the Trust Center Link Key.
 *    Use with ZG_SECURITY_SE_STANDARD
 *
 *   shortAddr - Trust Center short address
 *   linkKey - Pointer to link key. The calling function 
 *                    allocates this space and saves it in NV.
 */
extern void APSME_TCLinkKeySetup( uint16 shortAddr, APSME_LinkKeyData_t *linkKey );
